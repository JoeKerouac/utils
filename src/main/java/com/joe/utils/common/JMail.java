...
public class JMail {
     ...
     *
     * @param properties
     *            配置文件，需要包含mail.username、mail.host、mail.password、mail.protocol四个键值对
     * @return JMail客户端
     */
    ...
    private class EmailTask implements Callable<Boolean> {
        ...
        public Boolean call() {
            ...
            try {
                ...
                bodyPart.setContent(body.body,
                    (body.html ? "text/html" : "text/plain") + ";charset=" + Charset.defaultCharset().name());
