...
public class BeanUtils {
     ...
     *            别名注解类型，支持{@link JsonProperty JsonProperty}和{@link XmlNode XmlNode}
     * @return map，当pojo为null时返回空map
     */
    public static Map<String, Object> convert(Object pojo, Class<? extends Annotation> annotationType) {
     ...
     *            pojo
     * @param annotationType
     *            别名注解类型，支持{@link JsonProperty JsonProperty}和{@link XmlNode XmlNode}，为null时自动获取，优先使用{@link JsonProperty
     *            JsonProperty}
     * @param hasNull
     *            是否包含null值，true表示包含
     * @return map，当pojo为null时返回空map
            ...
            if (writeMethod == null) {
                ...
                try {
                    customPropertyDescriptor =
                        convert(field, new PropertyDescriptor(name, readMethod, writeMethod), clazz);
